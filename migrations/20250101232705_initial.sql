...
DROP TRIGGER IF EXISTS update_broker_updated_at ON broker;

DROP FUNCTION IF EXISTS update_updated_at_column();

DROP TABLE IF EXISTS property_expenses;
DROP TABLE IF EXISTS broker_phone;
DROP TABLE IF EXISTS broker_external_links;
DROP TABLE IF EXISTS broker_property;
...
DROP TYPE IF EXISTS broker_link_type;
